...
* Simple Regression/ Clustering, good fit for the  problem.  After plotting each ticker over a period of time, we can use machine learning to predict future pricing.  
...
#
This model is used to make a predictive model for electricity.  The dataset can be imported into a Postgresql table or read in as a csv file using Pandas.  All 3 programs are in github, in addition to Pandas to Postgresql and Postgresql to Pandas examples. 
#
