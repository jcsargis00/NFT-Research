...
import json
import pandas as pd
api_url= 'https://api.coinmarketcap.com/data-api/v3/cryptocurrency/historical?id=3&convertId=2781&timeStart=1643514218&timeEnd=1653878618'
...
print(df)
df.to_csv('usdt.csv',index = False)
