...
api_url= 'https://api.coinmarketcap.com/data-api/v3/cryptocurrency/historical?id=1&convertId=2781&timeStart=1643514218&timeEnd=1653878618'
...
fig=px.line(df, x='date',y="close").update_layout(xaxis_title="Date", yaxis_title="Bitcoin")
fig.show()